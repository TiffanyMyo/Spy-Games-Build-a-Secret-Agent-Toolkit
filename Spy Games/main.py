...
def main():
    global library_visited, library_solved
    while True:
        print("\n1. Bedroom")
        print("2. Library")
        print("3. Kitchen")
                    ...
                    for i in range(1, 5):
                        ...
                        if answer1 == gen():
                            ...
                            if answer2.upper() == "Y":
                                ...
                                for i in range(1, 4):
                                    answer3 = input("What's the password? ")
                                    if answer3.lower() == "man":
                                        print("Congrats! You left with an extra 1 million dollars!")
                                        exit()
                                    else:
                                        print("Try again...")
                        else:
...
result = ""
def toolkit():
    global library_solved, library_visited, val1, val2, result
    while True:
